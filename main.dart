  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      children: <Widget>[
        ...
        Text('Selected Roti Item: ${selectedRotiItem ?? "None"}'),
        Text('Selected North Indian Recipe: ${selectedRecipeItem ?? "None"}'),
        Text('Selected Breakfast Item: ${selectedBreakfastItem ?? "None"}'),
        Text('Selected South Indian Recipe: ${selectedSouthIndianRecipeItem ?? "None"}'),
        Text('Selected South Indian Fry Curry: ${selectedSouthIndianFryItem ?? "None"}'),
        Text('Selected South Indian Liquid Item: ${selectedSouthIndianLiquidItem ?? "None"}'),
        Text('Selected Chaat Item: ${selectedChaatItem ?? "None"}'),
        Text('Selected Fruit Item: ${selectedFruitItem ?? "None"}'),
        Text('Selected Italian Item: ${selectedItalianItem ?? "None"}'),
        Text('Selected Chinese Counter: ${selectedChineseCounter ?? "None"}'),
        Text('Selected Paan Counter: ${selectedPaanCounter ?? "None"}'),
        Text('Selected SouthIndianDesserts: ${selectedSouthIndianDesserts ?? "None"}'),
        Text('Selected SpecialSweets: ${selectedSpecialSweets ?? "None"}'),
        Text('Selected IceCream: ${selectedIceCream ?? "None"}'),
        Text('Selected WelcomeDrinks: ${selectedWelcomeDrinks ?? "None"}'),
        Text('Selected Starters: ${selectedStarters ?? "None"}'),
        Text('Selected Soups: ${selectedSoups?? "None"}'),
        Text('Selected Pachadi: ${selectedPachadi ?? "None"}'),
        Text('Selected Powders: ${selectedPowders ?? "None"}'),
        Text('Selected Papads: ${selectedPapads ?? "None"}'),
      ],
    )
  );
  }
